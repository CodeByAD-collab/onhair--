// APP.JSX WITH WHATSAPP REDIRECT
import { useState, useEffect } from 'react';
import './index.css'; 
import { Toaster, toast } from 'react-hot-toast';
import { Clock, Check, Moon, Sun, Globe, User, MapPin } from 'lucide-react';
import logo from './assets/logo.png'; 

// !!! CHANGE THIS TO THE OWNER'S WHATSAPP NUMBER !!!
...
export default function App() {
  ...
  const handleSubmit = async () => {
    ...
    const waMessage = `Bonjour ON H'AIR STUDIO, je souhaite confirmer ma réservation :
...
📍 *Type* : ${isFirstTime ? "Nouvelle Cliente" : "Habituée"}`;

    const bookingData = {
      name: clientFullName, phone: phoneNumber, date, time,
      ...
      <div className="booking-card">
        <div className="card-header">
            <div className="header-top">
                <div className="logo-area"><img src={logo} alt="Logo" style={{ height: '35px' }} /></div>
        ...
        <div className="card-body">
                ...
                <div className="fade-in">
                    ...
                    <div className="form-area">
                        ...
                        <div style={{display:'flex', gap:10}}>
                           <input className="modern-input" style={{flex:1}} placeholder="Prénom" value={firstName} onChange={e => setFirstName(e.target.value)}/>
                           <input className="modern-input" style={{flex:1}} placeholder="Nom" value={lastName} onChange={e => setLastName(e.target.value)}/>
                        </div>
                        <div style={{display:'flex', gap:10, marginTop:15}}>
                            <div className="modern-input" style={{width:80, textAlign:'center'}}>+212</div>
                        ...
                        <select className="modern-input" style={{fontSize: '13px', color: 'white', backgroundColor: '#18181b'}} value={staff} onChange={e => setStaff(e.target.value)}>
            ...
            {step === 4 && (
                <div className="fade-in success-screen">
                    ...
                    <p>Merci {firstName}, votre RDV est enregistré et WhatsApp a été ouvert.</p>
        ...
        {step < 4 && (
            <div className="card-footer">
                ...
                <button className="btn-primary" onClick={step === 3 ? handleSubmit : () => setStep(step + 1)} disabled={(step === 1 && selectedServices.length === 0) || (step === 2 && !time) || (step === 3 && (!firstName || !lastName || !phoneNumber || isFirstTime === null || loading))}>
