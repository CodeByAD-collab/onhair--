...
import { X, Trash2, User, Scissors, Calendar, UserCheck } from 'lucide-react'; // J'ai ajouté UserCheck pour l'icone du staff
    ...
    return (
        <div style={styles.overlay}>
            <div style={styles.modal}>
                ...
                {/* Header avec Couleur du Staff */}
                <div style={{...styles.header, borderLeft: `6px solid ${event.bgColor}`}}>
                    ...
                    <div style={styles.row}>
                        ...
                        <div>
                            ...
                            <div style={styles.value}>
                                {moment(event.start).format('D MMMM YYYY')} <br/>
...
const styles = {
    ...
    modal: {
        backgroundColor: '#18181b', width: '400px', borderRadius: '16px',
        border: '1px solid #27272a', overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.5)'
    },
    header: {
    ...
    closeBtn: { background: 'transparent', border: 'none', color: '#9ca3af', cursor: 'pointer' },
    content: { padding: '25px', display: 'flex', flexDirection: 'column', gap: '20px' },
    row: { display: 'flex', alignItems: 'center', gap: '15px' },
    iconBox: {
        width: 40, height: 40, borderRadius: '50%', backgroundColor: '#27272a',
        display: 'flex', alignItems: 'center', justifyContent: 'center'
    },
    label: { fontSize: 12, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '0.5px' },
    value: { fontSize: 16, color: 'white', fontWeight: '500' },
    footer: {
        padding: '20px', borderTop: '1px solid #27272a',
        display: 'flex', justifyContent: 'space-between', gap: 10
    },
    deleteBtn: {
        flex: 1, backgroundColor: 'rgba(239, 68, 68, 0.1)', color: '#ef4444',
        border: '1px solid #ef4444', padding: '10px', borderRadius: '8px',
        cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, fontWeight:'bold'
    },
    cancelBtn: {
        flex: 1, backgroundColor: 'transparent', color: 'white',
        border: '1px solid #52525b', padding: '10px', borderRadius: '8px',
